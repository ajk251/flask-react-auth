...
import { Box, Flex, Heading, Link, Spacer, IconButton, Stack, Collapse, useDisclosure } from "@chakra-ui/react";
  ...
  return (
    <Box bg="gray.800" px={4}>
      <Flex h={16} alignItems="center" justifyContent="space-between">
        ...
        <IconButton display={{ base: "flex", md: "none" }} onClick={onToggle} icon={isOpen ? <CloseIcon /> : <HamburgerIcon />}
                    variant="outline" aria-label="Toggle Navigation" color="white"/>
      </Flex>
