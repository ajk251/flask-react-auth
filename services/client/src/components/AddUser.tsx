...
interface UserObject { username: string;  email: string; password?: string; created_date?: string;}

interface AddUserProps { addUserToList: (user: UserObject) => void;}
  ...
  const handleSubmit = async (
    ...
    try {
      ...
      if (response.status === 201) {
        ...
        const newUser = {username: values.username,
                         email: values.email,
